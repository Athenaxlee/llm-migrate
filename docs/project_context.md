...
### Guided run workspace surface (V1.2, extended through V1.6.0-c)
...
`LLM_MIGRATE_TOOLSET=guided` exposes exactly these 23 tools for hosts with
...
scaffold_evaluation              (V1.6.0-c; DRAFT, plan-bound)
...
get_run_status / list_adaptation_tasks
      ↓
[discovery_incomplete: add_prompt_sources / confirm_prompt_consumer]
      ↓
